...
const Chatbot = () => {
    ...
    const handleSaveResult = (selectedClass, attributes) => {
        const resultRef = ref(database, 'result');
        push(resultRef, { selectedClass, attributes });
        console.log("Resultado salvo no banco de dados:", { selectedClass, attributes });
